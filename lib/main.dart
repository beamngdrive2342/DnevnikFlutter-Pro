...
class DnevnikApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Р В РІР‚СњР В Р вЂ¦Р В Р’ВµР В Р вЂ Р В Р вЂ¦Р В РЎвЂР В РЎвЂќ',
...
// Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™
// ROLE GATE Р Р†Р вЂљРІР‚Сњ simple PIN-code role selection on first launch
// Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™Р Р†РІР‚СћРЎвЂ™
...
class _RoleGateState extends State<RoleGate> {
  ...
  // Admin PIN Р Р†Р вЂљРІР‚Сњ can be changed by admin later
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                  'Р В Р РѓР В РЎвЂќР В РЎвЂўР В Р’В»Р РЋР Р‰Р В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р В РІР‚СњР В Р вЂ¦Р В Р’ВµР В Р вЂ Р В Р вЂ¦Р В РЎвЂР В РЎвЂќ',
                  style: TextStyle(
              ...
              const Text(
                  'Р В РІР‚в„ўР РЋРІР‚в„–Р В Р’В±Р В Р’ВµР РЋР вЂљР В РЎвЂР РЋРІР‚С™Р В Р’Вµ Р РЋР вЂљР В РЎвЂўР В Р’В»Р РЋР Р‰ Р В РўвЂР В Р’В»Р РЋР РЏ Р В Р вЂ Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂР В Р’В°',
                  style: TextStyle(
                    fontSize: 14,
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text(
                      'Р В РІР‚в„ўР В РЎвЂўР В РІвЂћвЂ“Р РЋРІР‚С™Р В РЎвЂ Р В РЎвЂќР В Р’В°Р В РЎвЂќ Р РЋРЎвЂњР РЋРІР‚РЋР В Р’ВµР В Р вЂ¦Р В РЎвЂР В РЎвЂќ'),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text(
                      'Р В РІР‚в„ўР В РЎвЂўР В РІвЂћвЂ“Р РЋРІР‚С™Р В РЎвЂ Р В РЎвЂќР В Р’В°Р В РЎвЂќ Р В Р’В°Р В РўвЂР В РЎВР В РЎвЂР В Р вЂ¦'),
  ...
  Future<void> _showAdminPinDialog() async {
    ...
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text(
            'Р В РІР‚в„ўР В Р вЂ Р В Р’ВµР В РўвЂР В РЎвЂР РЋРІР‚С™Р В Р’Вµ PIN Р В Р’В°Р В РўвЂР В РЎВР В РЎвЂР В Р вЂ¦Р В РЎвЂР РЋР С“Р РЋРІР‚С™Р РЋР вЂљР В Р’В°Р РЋРІР‚С™Р В РЎвЂўР РЋР вЂљР В Р’В°',
            ...
            onPressed: () {
              if (pinController.text == _adminPin) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text(
                          'Р В РЎСљР В Р’ВµР В Р вЂ Р В Р’ВµР РЋР вЂљР В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ PIN')),
                );
              }
            },
            child: const Text(
                'Р В РІР‚в„ўР В РЎвЂўР В РІвЂћвЂ“Р РЋРІР‚С™Р В РЎвЂ'),
          ),
        ],
      ),
    );
...
class _MainScreenState extends State<MainScreen> {
  ...
  Future<void> _showAddHomeworkModal() async {
    ...
    messenger.showSnackBar(
      SnackBar(
        content: Text('Задание по ${result.subject} добавлено'),
      ),
    );
  }
  ...
  Widget? _buildGlassyNavBar() {
    ...
    final items = <BottomNavigationBarItem>[
      ...
      const BottomNavigationBarItem(
          ...
          label: 'Р В РЎвЂ™Р В РўвЂР В РЎВР В РЎвЂР В Р вЂ¦'),
    ];
  ...
  Future<void> _submit() async {
    ...
    if (_selectedSubject == null || _taskController.text.trim().isEmpty) {
      messenger.showSnackBar(
        const SnackBar(
            content: Text(
                'Р вЂ”Р В°Р С—Р С•Р В»Р Р…Р С‘РЎвЂљР Вµ Р С—РЎР‚Р ВµР Т‘Р СР ВµРЎвЂљ Р С‘ Р В·Р В°Р Т‘Р В°Р Р…Р С‘Р Вµ')),
      );
      return;
    }
    ...
    if (hasError) {
      ...
      messenger.showSnackBar(
        const SnackBar(
          content: Text(
              'Р С›РЎв‚¬Р С‘Р В±Р С”Р В° Р С—РЎР‚Р С‘ Р В·Р В°Р С–РЎР‚РЎС“Р В·Р С”Р Вµ РЎвЂћР С•РЎвЂљР С• Р Р† Р С•Р В±Р В»Р В°Р С”Р С•. Р СџР С•Р С—РЎР‚Р С•Р В±РЎС“Р в„–РЎвЂљР Вµ Р ВµРЎвЂ°РЎвЂ РЎР‚Р В°Р В·.'),
        ),
      );
      return;
    }
    ...
    if (!success) {
      ...
      messenger.showSnackBar(
        const SnackBar(
          content: Text(
              'Р С›РЎв‚¬Р С‘Р В±Р С”Р В° Р С—РЎР‚Р С‘ РЎРѓР С•РЎвЂ¦РЎР‚Р В°Р Р…Р ВµР Р…Р С‘Р С‘ Р Р† Р В±Р В°Р В·РЎС“ Р Т‘Р В°Р Р…Р Р…РЎвЂ№РЎвЂ¦.'),
        ),
      );
      return;
    }
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      const Text(
                        'Р вЂќР С•Р В±Р В°Р Р†Р С‘РЎвЂљРЎРЉ Р В·Р В°Р Т‘Р В°Р Р…Р С‘Р Вµ',
                        style: TextStyle(
                          fontFamily: AppTheme.fontSerif,
                          fontSize: 22,
                  ...
                  _buildFormLabel('Р СџРЎР‚Р ВµР Т‘Р СР ВµРЎвЂљ'),
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        hint: Text(
                          'Р вЂ™РЎвЂ№Р В±Р ВµРЎР‚Р С‘РЎвЂљР Вµ Р С—РЎР‚Р ВµР Т‘Р СР ВµРЎвЂљ',
                          style: TextStyle(
                  ...
                  const SizedBox(height: 16),
                  _buildFormLabel('Р вЂ”Р В°Р Т‘Р В°Р Р…Р С‘Р Вµ'),
                  const SizedBox(height: 6),
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'Р С›Р С—Р С‘РЎв‚¬Р С‘РЎвЂљР Вµ Р В·Р В°Р Т‘Р В°Р Р…Р С‘Р Вµ...',
                      hintStyle: TextStyle(
                          color: AppTheme.onSurface3.withValues(alpha: 0.8)),
                      filled: true,
                  ...
                  const SizedBox(height: 16),
                  _buildFormLabel(
                      'Р В¤Р С•РЎвЂљР С• (Р Р…Р ВµР С•Р В±РЎРЏР В·Р В°РЎвЂљР ВµР В»РЎРЉР Р…Р С•)'),
                  const SizedBox(height: 6),
                  GestureDetector(
                      ...
                      child: _pickedImagePaths.isEmpty
                          ? Row(
                              ...
                              children: [
                                ...
                                Text(
                                  'Р вЂќР С•Р В±Р В°Р Р†Р С‘РЎвЂљРЎРЉ РЎвЂћР С•РЎвЂљР С•',
                                  style: TextStyle(
                                    color: AppTheme.onSurface3
                                        .withValues(alpha: 0.8),
                                    fontSize: 14,
                  ...
                  const SizedBox(height: 16),
                  _buildFormLabel('Р РЋРЎР‚Р С•Р С” РЎРѓР Т‘Р В°РЎвЂЎР С‘'),
                  const SizedBox(height: 6),
                  GestureDetector(
                    onTap: _isUploading
                        ? null
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isUploading
                          ...
                          : const Text(
                              'Р РЋР С•РЎвЂ¦РЎР‚Р В°Р Р…Р С‘РЎвЂљРЎРЉ Р В·Р В°Р Т‘Р В°Р Р…Р С‘Р Вµ'),
                    ),
                  ),
                  const SizedBox(height: 16),
                ],
